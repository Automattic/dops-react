...
var ReactSlider = React.createClass({
	...
	_buildHandleStyle: function(offset, i) {
		...
		return m(this.styles.handle, style);
	},
	...
	_buildBarStyle: function(min, max) {
		...
		return m(this.styles.bar, this.styles.horizontalBar, obj);
	},
	...
	_renderHandle: function(style, child, i) {
		...
		if (this.state.index === i) {
			style = m(style, this.styles.activeHandle);
		}
	...
	_renderBar: function(i, offsetFrom, offsetTo) {
		...
		return (
			React.createElement("div", {key: 'bar' + i, ref: 'bar' + i, className: className, style: style})
		);
	},
	...
	render: function() {
		...
		return (
			React.createElement("div", {ref: "slider", 
				style: m(this.styles.container, this.props.style), 
				className: className, 
