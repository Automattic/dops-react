...
var Tabs = React.createClass({displayName: "Tabs",
	...
	render: function() {
		...
		return (
			React.createElement("div", null, 
				...
				React.createElement("div", {style: theme.content}, 
	...
	_renderNav: function(theme) {
		return (
			React.createElement("ul", {style: theme.wrapper}, 
				React.Children.map(this.props.children, function( child, index ) {
					...
					return (
						React.createElement("li", {key: index, style: theme.item}, 
							React.createElement("a", {href: "#", ref: ref, onClick: this.handleSelectTab.bind(this, index), onMouseOver: this.handleMouseOverTab.bind(this, index), onMouseOut: this.handleMouseOutTab.bind(this, index), style: m(theme.link, (active||hover) && theme.activeLink)}, title)
						)		
					);
				}.bind(this)), 
				React.createElement("div", {style: styles.clear})
