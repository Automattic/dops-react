...
var Face = React.createClass({displayName: "Face",
	...
	_leftEyeStyle: function() {
		return m(this._eyeStyle(), {left: (this.props.size/-4)});
	},

	_rightEyeStyle: function() {
		return m(this._eyeStyle(), {right: (this.props.size/-4)});
	},
	...
	render: function() {
		return (
			React.createElement("div", {style: this._wrapperStyle()}, 
				React.createElement("span", {style: this.style.eyeWrapperStyle}, 
					React.createElement("div", {style: this._leftEyeStyle()}), 
					React.createElement("div", {style: this._rightEyeStyle()})
				), 
				React.createElement("span", {style: this._mouthStyle()})
			)
		);
	}
});
