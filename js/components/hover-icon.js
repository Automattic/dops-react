...
var HoverIcon = React.createClass({displayName: "HoverIcon",
	...
	render: function() {
		return (
			React.createElement(Icon, {name: this.props.name, style: this.styles.icon, onMouseOver: this.handleMouseOver, onMouseOut: this.handleMouseOut}, 
